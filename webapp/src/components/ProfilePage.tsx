  ...
  return (
    <div className="page fade-in">
      <div className="page-header">
        ...
        <p className="pg-subtitle">Ваша статистика и достижения</p>
      </div>
      ...
      <div className="card">
        ...
        <button className="btn btn-w" onClick={onTopup}>
          💰 Пополнить баланс
        </button>
        {isOwner && (
          <button className="btn btn-outline btn-mt" onClick={onAdmin}>
            ⚙️ Управление
          </button>
        )}
      </div>
